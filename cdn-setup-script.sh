...
# gsutil -m cp -r gs://acg-gcloud-course-resources/network-engineer/cdn/images/* gs://$PROJECT_ID-images/
...
gcloud compute instance-templates create cdn-demo-template --machine-type=f1-micro --metadata=startup-script-url=gs://acg-gcloud-course-resources/network-engineer/cdn/cdn-website-script.sh --tags=http-server --boot-disk-device-name=cdn-demo-template
